...
<div id='frameSlider' style='width:980px; margin:0px auto; text-align:center; padding-left: 20%;margin-top:-20px;margin-left:5%;'> <!-- slider -->
    ...
    <div id="slideshow-main" style="margin-left:-55px; margin-top:-50px;border: 15px solid #f1f0ef;padding-bottom:70px;">
        <ul>
            <li class="p1 active">
                <a href="#">
                    <img src="imagens/imgCeramica1.jpg" width="650" height="360" alt=""/>
            ...
            <li class="p2">
                <a href="#">
                    <img src="imagens/imgCeramica2.jpg" width="650" height="360" alt=""/>
                    <<!--span class="opacity"></span>
                    <span class="content"><h1>Cerâmica Barrobello</h1><p>Imagem superior da fábrica.</p></span> -->
                </a>
            </li>
            <li class="p3">
                <a href="#">
                    <img src="imagens/imgCeramica3.jpg" width="650" height="360" alt=""/>
                    <!--span class="opacity"></span>
                    <span class="content"><h1>Cerâmica Barrobello</h1><p>Imagem superior da fábrica.</p></span> -->
                </a>
            </li>
            <li class="p4">
                <a href="#">
                    <img src="imagens/imgCeramica4.jpg" width="650" height="360" alt=""/>
                    <!--span class="opacity"></span>
                    <span class="content"><h1>Cerâmica Barrobello</h1><p>Imagem superior da fábrica.</p></span> -->
                </a>
            </li>
...
<div style='width:980px; padding-top:50px; text-align:center;margin-left:20%;'><img src=imagens/certificacao.png></div><br><br>
